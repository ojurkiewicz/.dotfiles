...
local on_attach = function(_, bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>so', [[<cmd>lua require('telescope.builtin').lsp_document_symbols({ignore_symbols = 'variable'})<CR>]], opts)
...
local servers = { 'svelte', 'eslint', 'clangd', 'rust_analyzer', 'pyright', 'tsserver', 'gopls' }
